...
interface SearchApi {
  (params?: any): BaseResponse<PageData<any>>;
}

type ParseDataType<S> = S extends (params?: any) => BaseResponse<PageData<infer T>> ? T : S;
  ...
  const getPageData = useCallback(
    async (params: Record<string, any> = {}) => {
      ...
      if (pageApi) {
        ...
        if (res.code) {
          setPageData({ total: res.data.total, data: res.data.data });
        }
      }
    },
